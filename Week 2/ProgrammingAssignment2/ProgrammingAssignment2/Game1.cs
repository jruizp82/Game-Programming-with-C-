...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sprite0 = Content.Load<Texture2D>("bart");
            sprite1 = Content.Load<Texture2D>("homero");
            sprite2 = Content.Load<Texture2D>("lisa");
            sprite3 = Content.Load<Texture2D>("maggie");
            sprite4 = Content.Load<Texture2D>("marge");
